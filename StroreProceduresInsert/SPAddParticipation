...
AS
  ...
  BEGIN
    ...
    ( race_time,   meeting_date,  horse_id,  jockey_id,  trainer_id,  cur_horse_weight,cur_horse_age, star_pos, end_pos, winnings)
    VALUES( @race_time, @meeting_date, @horse_id, @jockey_id, @trainer_id, @curHorseWeight, @curHorseAge, @star_pos, @end_pos, @winnings);
  END
GO