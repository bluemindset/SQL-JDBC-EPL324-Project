...
//
//	    public static final String connection_url = "jdbc:sqlserver://apollo.in.cs.ucy.ac.cy:1433;databaseName="+DATABASE_USER_ID+";user="+DATABASE_USER_ID+";password="+DATABASE_PASSWORD+";";
//
	    //for tomis
//
